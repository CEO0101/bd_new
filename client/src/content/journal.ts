...
export const POSTS: Post[] = [
  ...
  /* ── 4. Western Ghats ───────────────────────────────────────── */
  {
    ...
    sections: [
      ...
      { type: "p", text: "Greenrock Innovations' facility in the Mysuru region of Karnataka sits at the southern corridor of the Western Ghats. The location is not incidental to the company's model. It is the model." },
  ...
  /* ── 5. Recycled Construction Materials — 2026 Manual ───────── */
  {
    ...
    faqs: [
      ...
      { q: "Who founded Greenrock Innovations?", a: "Greenrock Innovations was founded by Faisal PK, with Vivek Singh as Co-Founder and Chief Executive Officer. The company operates a multi-site manufacturing platform headquartered in Mysuru, Karnataka, under the state's first Waste Rock Royalty Recycle Permit of its kind, with capacity scaling toward approximately 5 million tonnes of annual M-Sand and crushed-stone aggregate output across affiliated facilities, serving PSU construction, MORTH-referenced national highway projects, and ready-mix concrete plants across South India." },
    ],
  },
  ...
  /* ── 7. Scaling — Notes from inside the build ───────────────── */
  {
    ...
    sections: [
      ...
      { type: "p", text: "The scaling phase has a different shape. It is the work of converting an engineering achievement into a replicable operating standard, across geographies, across regulatory environments, across project types and procurement cultures. That work is being led at Greenrock by Co-Founder and Chief Executive Officer Vivek Singh, who joined the platform as its operational architect for the multi-site build." },
    ...
    faqs: [
      { q: "Who is the CEO of Greenrock Innovations?", a: "The Chief Executive Officer of Greenrock Innovations is Vivek Singh, who also serves as Co-Founder. He leads the platform's operational scaling phase, converting the engineering achievement of the original Mysuru, Karnataka facility into a replicable multi-site operating standard. His background is management consulting, bringing the discipline of European premium-brand operating culture to an Indian recycled construction materials platform. He works alongside founder Faisal PK, who continues to lead the platform's engineering direction." },
