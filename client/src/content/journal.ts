...
export const POSTS: Post[] = [
  ...
  /* ── 3. Embodied carbon ─────────────────────────────────────── */
  {
    ...
    sections: [
      ...
      { type: "p", text: "Greenrock Innovations' production model, built on waste rock and weathered rock from Karnataka's quarrying sector, achieves approximately 70% lower carbon output per tonne of finished aggregate compared to conventional primary-extraction manufactured sand. This is not a projection. It is a consequence of the feedstock arithmetic." },
      { type: "hr" },
    ...
    faqs: [
      ...
      { q: "What does 70% lower carbon mean for manufactured aggregate?", a: "Approximately 70% lower carbon output means each tonne of finished material produces roughly 30% of the carbon of a conventional primary-extraction equivalent. The reduction comes principally from eliminating the extraction phase. Processing and transport carbon remain." },
