...
export const POSTS: Post[] = [
  ...
  /* ── 6. Karnataka MDP — Rule 3-C(4) field reference ─────────── */
  {
    ...
    sections: [
      /* ── Opening: definition-first, no metaphor ── */
      { type: "p", text: "On any given working day in Karnataka, several thousand tipper trucks leave the state's licensed stone crusher units carrying between fifteen and thirty tonnes of aggregate apiece. Every one of those movements is required, by law, to be accompanied by a Mineral Dispatch Permit — the MDP — issued under Rule 3-C(4) of the Karnataka Regulation of Stone Crusher Rules, read together with the Karnataka Minor Mineral Concession (KMMC) Rules. The MDP is the document that converts a tonnage of aggregate sitting on the back of a tipper from contraband into commerce." },
      { type: "p", text: "In operational terms, it is three documents folded into one. It is a royalty receipt — proof that the appropriate per-tonne charge has been paid to the Karnataka Department of Mines and Geology before the material left the crusher gate. It is a transport authorisation — a specification of the exact vehicle, the exact route, the exact destination, and the exact time window within which the load is legally allowed to move. And it is an audit trail — a barcoded, QR-coded record that ties a particular tonnage to a particular buyer, a particular lease, and a particular processing unit, recoverable from the portal long after the consignment has been delivered and the truck has returned for its next load." },
      ...
      { type: "p", text: "This is, in short, the system within which the manufactured-sand and graded-aggregate categories in Karnataka now operate — and within which Green Rock (operating as Greenrock Innovations through its licensed entity Begur Sands Pvt. Ltd. in Gundlupet) and a handful of other organised operators in the state have built their dispatch and traceability infrastructure." },
      { type: "hr" },
      ...
      /* ── Classification ── */
      { type: "h2", text: "Classification — and why it determines what you pay" },
      ...
      /* ── Khanijadmg portal ── */
      { type: "h2", text: "The Khanijadmg portal — how an MDP gets generated" },
      ...
      { type: "p", text: "For a crusher unit running a hundred or more dispatches a day — the working tempo at the Green Rock Begur Sands operation, for instance, where dispatch is built into the standard operating procedure rather than retrofitted around it — the portal is in continuous use, and the operational discipline it imposes is non-trivial. There are units in the state that have, more than once, lost a day's dispatch capacity to a portal validation failure on a single field. The systems that work alongside it — the weighbridge, the gate logbook, the dispatch desk — are configured to feed the portal cleanly, and on the units where they are not, the cost is paid in cancelled MDPs and rolled-back loads." },
      { type: "hr" },

      /* ── Validity windows ── */
      { type: "h2", text: "Validity windows and route discipline" },
      { type: "p", text: "The MDP carries a validity window — a tight time band, typically running from the moment the permit is generated to a specified expiry timestamp a small number of hours later. The window is calibrated against the distance from the dispatching unit to the declared destination, with allowance for lawful driving hours and reasonable rest. A 113-kilometre run from a Gundlupet crusher to Mananthavady in Wayanad — the kind of inter-state movement that Green Rock dispatches against contracted Kerala-side volumes — will typically carry a validity window in the region of eight hours; a shorter run within the district carries a correspondingly shorter window." },
      ...
      { type: "p", text: "Operators in the category typically standardise on a small set of tipper configurations — most commonly 20- and 30-tonne tippers, with the occasional larger configuration for nearby destinations — to keep this layer of compliance simple. Mixed-fleet operators carry the small additional overhead of category-matching every dispatch to a category-compliant vehicle." },
      { type: "hr" },
      ...
      { type: "p", text: "In operational terms, this typically means a water-sprinkler array running over the crushing and screening sections; a covered or wind-broken stockpile arrangement; periodic damping of the internal haul roads; and a covered or tarpaulin-secured load on every dispatched vehicle. Units that have invested in closed-loop water recycling — Green Rock's Begur Sands facility, for instance, runs a zero-liquid-discharge water system across both its dust-suppression array and its core processing — tend to be favoured at CTO renewal, because their net water draw against the consent ceiling is structurally lower than at a unit relying on open-loop sprinkler intake." },
      ...
      { type: "p", text: "This is the framework within which the next phase of low-carbon construction materials supply in Karnataka, and arguably in South India more broadly, is going to be built. Green Rock, processing waste rock and weathered rock at its Begur Sands Pvt. Ltd. facility in Gundlupet under the same Rule 3-C(4) regime described above, is one example of how the MDP system has begun to be used for purposes beyond bare compliance — as the basis for an auditable, sub-categorised, lower-carbon supply chain that procurement is, slowly and unevenly, beginning to demand. Several other operators in the state are at different stages of the same transition." },
      ...
      /* ── Closing structural note (replaces a blanket disclaimer) ── */
      { type: "h2", text: "A note on entity structure" },
      { type: "p", text: "Green Rock is the operating brand of Greenrock Innovations, the parent platform headquartered in Gundlupet, Karnataka. The Karnataka Mineral Dispatch Permits referenced in this article are issued to and held by Begur Sands Pvt. Ltd., the licensed operating entity for the Gundlupet facility and the unit through which the waste-rock classification and the Khanijadmg dispatch flow are currently operated. Additional manufacturing facilities under the Green Rock platform are at various stages of the regulatory licensing process and will be brought under the same dispatch and traceability standard as they enter operation." },
    ...
    faqs: [
      ...
      { q: "What is Green Rock's relationship to the Karnataka Mineral Dispatch Permit system?", a: "Green Rock is the operating brand of Greenrock Innovations. The Karnataka Mineral Dispatch Permits relevant to the Green Rock platform are issued to Begur Sands Pvt. Ltd., the licensed operating entity for the Gundlupet, Karnataka facility under the Karnataka Regulation of Stone Crusher Rules. Green Rock operates inside the waste-rock classification band on every dispatch, runs a closed-loop zero-liquid-discharge water system on the processing line for KSPCB compliance, and maintains the dispatch protocol described in this article as part of standard operating procedure. Additional facilities under the platform are at various stages of the regulatory licensing process." },
    ],
  },
