...
const PRODUCT_FAQS = [
  ...
  },
  {
    ...
    a: "Greenrock graded aggregates are spec'd to IS 383:2016 coarse aggregate requirements with single-sized and blended 6 / 10 / 20 mm fractions. Crushing value ≤25%, flakiness index ≤25%, water absorption ≤1.0%, specific gravity 2.6–2.8. Suitable for road bases, foundations, RCC pours, and railway ballast per MORTH references.",
  },
];
...
export default function Products() {
  useSeo({
    ...
    description:
      "IS 383:2016 / IS 1542 compliant M-Sand, P-Sand, graded aggregates and granite fines — engineered from reclaimed weathered rock at ~70–82% lower carbon. Batch-stamped, NABL-tested, MORTH-referenced.",
    canonical: "/products",
    jsonLd: [
