...
export default function Products() {
  useSeo({
    ...
    description:
      "IS 383:2016 / IS 1542 compliant M-Sand, P-Sand, graded aggregates and granite fines — engineered from reclaimed weathered rock at ~70% lower carbon. Batch-stamped, NABL-tested, MORTH-referenced.",
    canonical: "/products",
    jsonLd: [
